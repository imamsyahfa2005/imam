exports.menu = (id, BotName, corohelp, tampilTanggal, tampilWaktu, instagram, waku, facebook, kapanbotaktif, grupch1, grupch2) => {
	return `🐧*${BotName}*🐧
